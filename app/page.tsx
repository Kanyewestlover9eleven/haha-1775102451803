...
const basePath = '/haha-1775102451803';
...
export default function Home() {
  ...
  const products = [{ n: 'Product 1', d: 'da: Our flagship product, designed to simplify and streamline your daily life with its cutting-edge features and user-friendly interface.', icon: 'domain' }, { n: 'Product 2', d: 'da: A revolutionary solution that combines performance, sustainability, and style, perfect for those seeking a unique and exceptional experience.', icon: 'architecture' }, { n: 'Product 3', d: 'da: A game-changing product that redefines the status quo, offering unparalleled quality, reliability, and value to our customers.', icon: 'chair' }, { n: 'Product 4', d: 'da: A cutting-edge innovation that sets new standards in its class, providing an unparalleled level of convenience, flexibility, and enjoyment.', icon: 'eco' }, { n: 'Product 5', d: 'da: Our latest masterpiece, crafted with precision and dedication to deliver an unforgettable experience, exceeding the highest expectations and setting a new benchmark for excellence.', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body">
      ...
      <section id="about" className="py-24 bg-surface">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <p className="text-on-surface-variant text-lg max-w-3xl mb-12">At haha, our story begins with a passion for innovation and a commitment to excellence. We\'re dedicated to making a positive impact through our products and services.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div><h4 className="font-bold text-primary">Vision</h4><p className="text-sm text-on-surface-variant">To be a leading force in our industry, driving growth and success through creativity and customer satisfaction.</p></div>
            <div><h4 className="font-bold text-primary">Mission</h4><p className="text-sm text-on-surface-variant">To deliver exceptional products and experiences that exceed our customers\' expectations, while fostering a culture of collaboration and continuous improvement.</p></div>
            <div><h4 className="font-bold text-primary">da</h4><p className="text-sm text-on-surface-variant">Customer-centricity: We prioritize our customers\' needs and strive to build long-lasting relationships through trust, empathy, and personalized support.</p></div>
            <div><h4 className="font-bold text-primary">da</h4><p className="text-sm text-on-surface-variant">Innovation: We encourage experimentation, learning, and innovation, embracing new ideas and technologies to stay ahead of the curve and drive progress.</p></div>
          </div>
        </div>
      </section>
